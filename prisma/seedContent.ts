...
const CITIES: PageSeed = {
  ...
  navLabel: 'Cities',
  heroTitle: 'Translation Services in 50+ Cities',
  heroSubtitle:
    'Pan-India certified translation services with physical office in Delhi NCR and digital delivery everywhere',
  metaTitle: 'All Cities — Translation Services Across India | Language Guru',
  metaDesc:
    'Certified translation services in 105+ Indian cities with digital submission and delivery.',
  showInNav: true,
  showInFooter: true,
  sortOrder: 40,
  sections: [
    {
      sectionKey: 'grid',
      kind: 'grid',
      settings: { source: 'cities', defaultIcon: '📍' },
    },
    {
      sectionKey: 'coverage',
      kind: 'stats',
      ...
      items: [
        ...
        { value: '12', suffix: 'K+', label: 'PIN CODES DELIVERED' },
        { value: '48', suffix: 'h', label: 'DIGITAL DELIVERY' },
        { value: '3', suffix: '–5', label: 'DAY COURIER' },
      ],
    },
    {
      sectionKey: 'how-it-works',
      kind: 'cards',
      heading: 'How Our Pan-India Service Works',
      subheading: 'Physical office in Delhi NCR, digital delivery everywhere else. Same certified quality – wherever you are.',
      items: [
        {
          badge: '📍 Physical Service',
          title: 'Delhi NCR',
          accent: 'primary',
          desc: 'Scanned copies via email / WhatsApp + hard-copy courier delivery across Delhi, Gurgaon, Noida, Faridabad, Ghaziabad.',
          points: [
            'Submit at our Delhi office or via email / WhatsApp',
            'Same-day rush service available',
            'Walk-in office at West End Mall, Janakpuri, New Delhi',
            'Free return courier of original + translation',
            'Notarization & MEA apostille in-house',
          ],
        },
        {
          badge: '🌐 Digital Service',
          title: 'Rest of India (150+ cities)',
          accent: 'accent',
          desc: 'Same ISO-certified, embassy-accepted translation – delivered digitally + by courier anywhere in India.',
          points: [
            'Upload scan/photo of document online',
            'Digital certified PDF emailed in 24–72h',
            'Hard-copy courier to any PIN code (3–5 days)',
            'Same translator credentials & ISO certificate',
            'WhatsApp / email coordination throughout',
          ],
        },
      ],
    },
    {
      sectionKey: 'services',
      kind: 'grid',
      heading: 'All {count} Services – Available Everywhere',
      subheading: 'Every translation service we offer is available in every city we serve. Same quality. Same certification. Same pricing.',
      buttonText: 'View All {count} Services →',
      buttonLink: '/services',
      settings: { source: 'services', limit: 12 },
    },
    {
      sectionKey: 'regions',
      kind: 'cards',
      heading: 'Translation Services Across India',
      subheading: '50+ cities organized by region. Click any city to see local pricing, document submission details, and language coverage.',
      items: [
...
async function seedHomeSections() {
  ...
  const bands = [
    ...
    },
    {
      ...
      title: 'Legal Translation <em>Services in India</em>',
      content:
        '<p>Language Guru is a certified translation agency in India providing top-notch legal document translation services to government agencies, law firms, corporates and individuals. Our legal document translation services are conducted by professional translators who deeply understand legal terminology in both source and target languages.</p><p>We understand the importance of confidentiality, especially with sensitive legal documents — and we ensure your information is safe under strict NDAs. Our legal translations are accepted by all Indian courts, foreign courts, MEA and embassies.</p><p>We have expertise in the legal translation of Court Orders, Business Contracts, Partnership Agreements, Court Judgments, Property Papers, Affidavits, Powers of Attorney, Wills, Patents and Trademark filings across 120+ languages.</p><p>Whether you need a single notarized affidavit or a large-scale multilingual legal contract project, our team delivers with precision, on time, and within your budget — with apostille and attestation services available under one roof.</p>',
    ...
    },
    {
      ...
      title: 'Document Translation <em>Services in India</em>',
      content:
        '<p>Language Guru is a leading document translation and transcription service provider in India. We specialize in converting your most important documents — personal, academic, legal, medical, financial and corporate — into 120+ languages with precision, formatting integrity and full embassy/government acceptance.</p><p>From a single birth certificate to thousands of pages of contracts and annual reports, our team of skilled native-speaker translators delivers high-quality certified translations on time, every time. Every document is reviewed by a second linguist and stamped with our ISO-9001:2015 and ISO 17100:2015 certification.</p><p>We serve individuals, corporates, law firms, hospitals, universities and government agencies across India. All translated documents are produced on official letterhead with a signed translator declaration — accepted by all embassies, MEA, Indian courts and international institutions without the need for re-certification.</p><p>Office submission or scanned copies via email / WhatsApp in Delhi NCR, and courier delivery across all 150+ Indian cities. WhatsApp or email your documents for an instant quote within 30 minutes.</p>',
    ...
    },
    {
      ...
      content:
        '<p>ISO-9001:2015 and ISO 17100:2015 certified translations accepted by every embassy, consulate, court and government office worldwide. Each translation includes a signed translator declaration on official letterhead, making it legally valid and embassy-ready without any additional certification requirement from the receiving authority.</p><p>Our certified translators are native speakers and qualified professionals — trained in legal, medical, technical and academic terminologies across all major language pairs. We cover 120+ languages with delivery as fast as 24 hours for urgent requirements across India.</p><p>Language Guru is a government-authorized, MSME-registered and MEA-empanelled certified translation agency in India. We handle all document types — visa applications, immigration files, corporate contracts and court submissions — with 100% accuracy and on-time delivery, every time.</p><p>All certified translations come with a formal statement of accuracy, company stamp, ISO certification seal and Agency Sign & Stamp. Hard copies with notarization and apostille are available on request, delivered to your address anywhere in India.</p>',
